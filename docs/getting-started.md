...
Смотрите файл [resources/useful-links.md](../resources/useful-links.md) для полного списка ресурсов.
...
3. **Откройте** [трекер прогресса](progress-tracker.md)
4. **Переходите** к первому занятию: [Основы Git](../lessons/01-git-basics/lesson-01-git-commands.md)
